...
class Waitress {
    ...
    public Waitress(PancakeHouseMenu pancakeHouseMenu, DinerMenu dinerMenu) { // here waitress is accepting constructors of concrete classes rather than interface.problem
